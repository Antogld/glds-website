...
const Footer = () => {
  return <>
    ...
    <footer class="rounded-xl bg-gray-100">
      <div class="container m-auto space-y-8 px-6 py-16 text-gray-600 md:px-12 lg:px-20">
        ...
        <div class="grid grid-cols-2 gap-6 sm:grid-cols-4">
          ...
          <div>
            <h6 class="text-lg font-medium text-cyan-900">Developers</h6>
            <ul class="mt-4 list-inside space-y-4">
              <li>
                <a href="#" class="transition hover:text-cyan-600">About</a>
              </li>
        ...
        <div class="flex justify-between rounded-md bg-gray-200 px-4 py-3 text-gray-600">
          <span>&copy; Galdiero <span id="year"></span></span>
          <a href="#" class="font-medium transition hover:text-cyan-600">2024</a>
        </div>
      </div>
    </footer>
